...
public class AreaCodeUtil {
    ...
    public static String resultStr(String idCard){

        String s = null;
        try {
            s = IDCardValidate(idCard);
        } catch (ParseException e) {

        }
        String ssx = idCard.substring(0, 6);//获取省市县的
        String nativePlace = getNativePlace(Integer.valueOf(ssx));//省市县
        ...
        return  s + "出生地："+nativePlace + " 生于" + year + "年" + month + "月" + day + "日" + "," + sex + "一枚";
    }
    ...
    public static String IDCardValidate(String IDStr) throws ParseException {
        ...
        // 判断地区码是否有效
        String areacode = getNameString(Integer.valueOf(Ai.substring(0, 2)));
    ...
    public static void main(String[] args) throws ParseException {
       ...
       /* Scanner s = new Scanner(System.in);
        ...
        System.out.println(s + "出生地："+nativePlace + " 生于" + year + "年" + month + "月" + day + "日" + "," + sex + "一枚");
    }
