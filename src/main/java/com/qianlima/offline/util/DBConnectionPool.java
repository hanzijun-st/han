...
//            FileInputStream fileInputStream = new FileInputStream("src/config/jdbc-mysql.properties");;
            //FileInputStream fileInputStream = new FileInputStream("application-dev.yml");;
            //properties.load(fileInputStream);
            /**获取属性文件中的值**/
            String driverClassName = properties.getProperty("com.mysql.jdbc.Driver");
            String url = properties.getProperty("jdbc:mysql://172.18.30.13:3309/qlm_ka?useUnicode=true&characterEncoding=utf8");
            String username = properties.getProperty("root");
            String password = properties.getProperty("qF2Z3cpMR6VVJBRt");
            ...
            /**设置数据库连接地址**/
            cpds.setJdbcUrl("jdbc:mysql://172.18.30.13:3309/qlm_ka?useUnicode=true&characterEncoding=utf8");
            /**设置数据库连接用户名**/
            cpds.setUser("root");
            /**设置数据库连接密码**/
            cpds.setPassword("qF2Z3cpMR6VVJBRt");
