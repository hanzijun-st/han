...
public class QianlimaZTUtil2 {
     ...
     * @return
     */
    public static Map<String, Object> getProposeDataByInfoId(String nzjUrl, String infoId) {
        ...
        try {
            ...
            HttpPost post = new HttpPost(nzjUrl);
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                log.warn("调用中台拟在建项目数据，http响应失败 contentid：{} httpcode:{}", infoId, httpResponse.getStatusLine().getStatusCode());
            }
